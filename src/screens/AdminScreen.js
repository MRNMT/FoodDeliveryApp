...
const AdminScreen = ({ navigation }) => {
    ...
    // Chart data from REAL user orders
    const revenueData = {
            ...
            >
                <View style={styles.headerContent}>
                    ...
                    <TouchableOpacity onPress={handleLogout}>
                        <Icon name="sign-out" type="font-awesome" color="#FFFFFF" size={24} />
                    </TouchableOpacity>
                </View>
            </LinearGradient>
